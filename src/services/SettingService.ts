...
export const updateAdminDataSer = async (reqBody: any, shopDetails: any) => {
    ...
    return prisma.shop_Owner.update({
        where: {
            id: shopDetails.shop_id
        },
        data: {
...
export const getCurrentQrImageSer = async (shopDetails: any) => {
    return prisma.shop_Owner.findUnique({
        where: {
            id: shopDetails.shop_id
        },
        select: {
